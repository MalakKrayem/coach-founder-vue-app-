<template>
  <form @submit.prevent="submit">
    <div class="form-control" :class="{ invalid: !firstName.isValid }">
      ...
      />
      <p v-if="!firstName.isValid">First name must'nt be empty!</p>
    </div>
    <div class="form-control" :class="{ invalid: !lastName.isValid }">
      ...
      />
      <p v-if="!lastName.isValid">Last name must'nt be empty!</p>
    </div>
    <div class="form-control" :class="{ invalid: !description.isValid }">
      ...
      ></textarea>
      <p v-if="!description.isValid">Description must'nt be empty!</p>
    </div>
    ...
    <p v-if="!formIsValid">Please fill the empty field!</p>
